...
# Build CedarPy .app and DMG for macOS using improved PyInstaller config
...
echo "Building CedarPy macOS app with PyInstaller (improved config)..."
...
DMG_PATH="$PROJ_ROOT/packaging/dist/$DMG_NAME"
