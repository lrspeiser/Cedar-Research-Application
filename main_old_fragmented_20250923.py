...
Notes:
- The previous full implementation has been copied to cedar_app/main_impl_full.py
- A backup snapshot of the original main.py is stored at main_backup_20250923.py
...
try:
    from cedar_app.main_impl_full import app  # FastAPI instance
...
try:  # noqa: F401
    from cedar_app.main_impl_full import (
        ...
        get_registry_db,
        get_project_db,
        # Project/engine helpers
        _get_project_engine,  # noqa: PLC2701 (private by legacy convention)
        ensure_project_initialized,
        # Models
        Base, Project, Branch, Thread, ThreadMessage, FileEntry, Dataset, Setting, Version, ChangelogEntry, SQLUndoLog, Note,
        # Utilities frequently used elsewhere
        interpret_file,
        record_changelog,
    )
except Exception:
